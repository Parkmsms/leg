...
import { Alert, Dimensions, Image, NativeScrollEvent, NativeSyntheticEvent, ScrollView, StyleSheet, Text, TouchableOpacity, View, VirtualizedList } from "react-native";
import { activeLocation, getAccessToken, getStoreList, getBannerList, getFoodKindsList } from "../config/AxiosFunction";
import Icon from 'react-native-vector-icons/Ionicons';
import { intialStorePrams, StoreParams } from "../models/storeInfo";
...
const MainPage = ({ navigation, route }: MainPageProps) => {
  ...
  useEffect(() => {
    console.log("검색어", route.params?.menu);
    if (route.params?.menu) {
      setParams({
        ...params,
        keyword: route.params?.menu.text
      })
    }
  ...
  const onPicturChange = (e: NativeSyntheticEvent<NativeScrollEvent>) => {
